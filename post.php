                                ...
                                <div class="author-bio media">
                                  ...
                                  <?php endif; ?>
                                    <div class="author-details media-body">
                                        <h3 class="name"><a href="#">Aniket Khote</a></h3>
                                        <p>
                                          <?php echo "$bio"; ?>
                                        </p>
                                        <div class="social">
                                          <a href="https://twitter.com/aniketkhote99" target="_blank"><i class="fa fa-twitter"></i></a>
                                          <a href="https://www.facebook.com/profile.php?id=100010274708019" target="_blank"><i class="fa fa-facebook"></i></a>
                                          <a href="https://www.instagram.com/aniket.khote/" target="_blank"><i class="fa fa-instagram"></i></a>
                                        </div>
                                    </div>
                                </div>
